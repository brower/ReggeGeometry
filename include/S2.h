...
double Circumradius(Eigen::Vector3d& r1, Eigen::Vector3d& r2, Eigen::Vector3d& r3)
{
  Eigen::Vector3d e1 = r3-r1;
  Eigen::Vector3d e2 = r2-r1;
  Eigen::Vector3d e3 = r2-r3;

  double l1 = e1.dot(e1); 
  double l2 = e2.dot(e2); 
  double l3 = e3.dot(e3); 

  return sqrt(l1*l2*l3)/(4*TriangleArea(r1,r2,r3)); 
}
double Perimeter(Eigen::Vector3d& r1, Eigen::Vector3d& r2, Eigen::Vector3d& r3)
{
  Eigen::Vector3d e1 = r3-r1;
  Eigen::Vector3d e2 = r2-r1;
  Eigen::Vector3d e3 = r2-r3;
